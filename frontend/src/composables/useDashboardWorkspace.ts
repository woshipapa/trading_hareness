...
type DragonLeaderWatch = { model_version?: string; status?: string; eligible?: boolean; rank?: number; leader_rank?: number | null; streak_count?: number; review_tier?: string; market_context?: { market_state?: string; observable_limit_up_count?: number; observable_multi_board_count?: number; highest_observed_streak?: number; sentiment_metrics?: { promotion_rate?: number | null; high_level_negative_feedback_rate?: number | null; board_repair_rate?: number | null; quality?: string; missing?: string[] } }; theme_context?: { label?: string | null; observable_limit_up_count?: number; observable_multi_board_count?: number; net_amount?: number | null; exact_member_mapping?: boolean }; session_confirmation?: { status?: string; required?: string[] }; score_shadow?: { status?: string; live_effect?: string; score?: number; max_available_score?: number; coverage_ratio?: number; score_scale?: string; reasons?: string[]; risk_flags?: string[]; components?: Record<string, unknown> }; playbook?: { model_version?: string; status?: string; live_effect?: string; notice?: string; plans?: Array<{ strategy_key?: string; eligible?: boolean; status?: string; missing?: string[] }>; next_session_confirmation_schema?: { status?: string; confirmed?: boolean; missing?: string[] } }; risk_flags?: string[] };
...
type RawOverflowHealth = { enabled?: boolean; state?: string; reasons?: string[]; hot_window_hours?: number; batch_rows?: number; queue?: { queue_depth?: number; verified?: number; failed?: number; last_verified_at?: string | null }; offsets?: { stream_key?: string; offset?: { effective_at?: string; observation_id?: string } | null }[]; live_effect?: string; cold_store_is_not_a_decision_input?: boolean };
...
type FactorEvaluation = { evaluation_id: string; research_run_id?: string | null; factor_key: string; label: string; status: string; observations: number; cross_section_days: number; horizon_days: number; metrics: Record<string, unknown>; artifact?: Record<string, unknown>; created_at?: string };
type ResearchRun = { research_run_id: string; experiment_type: string; strategy_key?: string | null; strategy_version?: string | null; universe_key?: string | null; start_date?: string | null; end_date?: string | null; knowledge_cutoff: string; data_manifest_id?: string | null; code_sha: string; data_schema_version: string; parameters: Record<string, unknown>; status: string; output_digest?: string | null; error_message?: string | null; started_at?: string; finished_at?: string | null; created_at?: string };
